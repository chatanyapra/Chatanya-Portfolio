  ...
  return (
    <div style={{height: '1510px'}} className='bg-gray-900'>
      <div className='image-main flex space-around'>
          ...
          <div className='user-name overflow-hidden text-left text-4xl text-gray-50 font-mono z-10' style={{ fontFamily: "Exo, sans-serif"}}><span className='text-6xl'>Hi,</span><br/>
                <span>I am {' '} {text}</span>
      ...
      <div ref={box2Container} className="box2-container overflow-hidden absolute w-full bg-gray-900" style={{height: '900px', top: '710px'}}>
          <div className='aboutme-box text-white rounded-2xl relative backdrop-opacity-5 z-10 backdrop-invert bg-black/50 py-7 overflow-x-hidden'>
            ...
            <h1 className='text-3xl mx-12 my-6' style={{ fontFamily: "Exo, sans-serif"}}>About me</h1>
            ...
            <h1 className='text-2xl mx-12 mt-10 mb-4'  style={{ fontFamily: "Exo, sans-serif"}}>What Sets Me Apart</h1>
            <div className='m-auto text-xl w-10/12'>
