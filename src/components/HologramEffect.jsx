...
import HologramRobot from '../assets/hologramImage.png'

export default function HologramEffect() {
  const [text] = useTypewriter({
    words: ["I'd love to hear from you!"],
    loop: {},
    deleteSpeed: 100,
    typeSpeed: 80,
    delaySpeed: 2000
  ...
  return (
    <div className='pb-10'>
      <div id="ContainerHologram">
        <div className="hologram-image">
          <img className='image-robot-hologram' src={HologramRobot} alt="" />
          <div className="message-box-robot absolute top-0 text-white">
              {text}
              <Cursor cursorColor='white' cursorStyle= {'|'} />
            <span className="border-message"><span className="border-mess-int"></span></span>
          </div>
        </div>
