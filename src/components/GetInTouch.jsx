  ...
  return (
    <div className='w-full h-72 bg-gray-900 p-24 flex justify-between'>
        ...
        <div className="w-52 flex justify-around py-9">
            <a href="#" target="_blank"><i class="fab fa-instagram text-white text-4xl"></i></a>
            <a href="#" target="_blank"><i class="fab fa-linkedin text-white text-4xl"></i></a>
            <a href="#" target="_blank"><i class="fab fa-github text-white text-4xl"></i></a>
        </div>
    </div>
  )
}
